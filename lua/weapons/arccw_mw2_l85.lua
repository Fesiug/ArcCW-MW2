...
SWEP.Attachments = {
    {
        ...
        Offset = {
            vpos = Vector(0, -2.95, 0), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
    ...
    },
    {
        ...
        Bone = "Weapon",
        Offset = {
            vpos = Vector(1, -1.4, 0.3), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, 0),
