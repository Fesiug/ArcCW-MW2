...
SWEP.Attachments = {
    {
        ...
        Offset = {
            vpos = Vector(1.5, 0, 3.1), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 0),
        },
    },
    {
    ...
    },
    {
        ...
        DefaultAttName = "None",
        Slot = {"mw2_wepcamo","mw2_wepedit_ak47"}, -- what kind of attachments can fit here, can be string or table
        FreeSlot = true,
    },
}
