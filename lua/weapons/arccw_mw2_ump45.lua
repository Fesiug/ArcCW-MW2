...
SWEP.Attachments = {
    {
        ...
        Offset = {
            vpos = Vector(-4.7, 0, 2.7), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 0),
    ...
    },
    {
        ...
        Bone = "tag_weapon",
        Offset = {
            vpos = Vector(6.5, -1.2, 0.3), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 90),
