...
SWEP.Attachments = {
    {
        ...
        Offset = {
            vpos = Vector(-0.8, -0.01, 1.9), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 0),
        },
    ...
    },
    {
        ...
        Bone = "j_bolt", -- relevant bone any attachments will be mostly referring to
        FreeSlot = true,
        Offset = {
    ...
    {
        PrintName = "Akimbotest", -- print name
        DefaultAttName = "No LH",
        Slot = "akimbotest", -- what kind of attachments can fit here, can be string or table
        Bone = "tag_view", -- relevant bone any attachments will be mostly referring to
        Offset = {
...
---------------------------------------------------------
    ...
    ["reload_akimbo_right"] = {
        ...
        SoundTable = {
						...
						{s = "weapons/fesiugmw2/foley/wpfoly_glock_reload_clipin_v1.wav", 	t = 39/24},
					},
        Checkpoints = {24, 97},
        FrameRate = 24,
    },
    ["reload_empty_akimbo_right"] = {
        ...
        SoundTable = {
						{s = "weapons/fesiugmw2/foley/wpfoly_glock_reload_lift_v1.wav", 	t = 0},
						{s = "weapons/fesiugmw2/foley/wpfoly_glock_reload_clipout_v1.wav", 	t = 4/24},
						{s = "weapons/fesiugmw2/foley/wpfoly_glock_reload_clipin_v1.wav", 	t = 45/24},
						{s = "weapons/fesiugmw2/foley/wpfoly_glock_reload_chamber_v1.wav", 	t = 65/24},
					},
        Checkpoints = {24, 97, 131},
        FrameRate = 24,
    },
