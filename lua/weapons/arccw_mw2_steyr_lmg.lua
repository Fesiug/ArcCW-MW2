...
SWEP.DamageMin = 40 * GetConVar("arccw_mw2_bal_dmgmul"):GetFloat() -- damage done at maximum range
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "tag_weapon",
        Offset = {
            vpos = Vector(-2, -0.5, 2), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 135),
