...
SWEP.Attachments = {
    {
        ...
        Offset = {
            vpos = Vector(-4, 0, 2.48), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 0),
    ...
    },
    {
        ...
        Bone = "tag_weapon",
        Offset = {
            vpos = Vector(-2, -0.8, 1.4), -- offset that the attachment will be relative to the bone
            vang = Angle(0, 0, 90),
